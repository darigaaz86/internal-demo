...
CREATE SEQUENCE if not EXISTS barrier_seq;
create table if not exists barrier(
  id bigint NOT NULL DEFAULT NEXTVAL ('barrier_seq'),
...
CREATE TABLE IF NOT EXISTS trans_in (
  id bigserial NOT NULL PRIMARY KEY,
  amount int NOT NULL
);
INSERT INTO trans_in (amount) VALUES (100);

CREATE TABLE IF NOT EXISTS trans_out (
  id bigserial NOT NULL PRIMARY KEY,
  amount int NOT NULL
);
INSERT INTO trans_out (amount) VALUES (100);